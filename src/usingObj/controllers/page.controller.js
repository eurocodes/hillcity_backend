...
const People = {
    getMentor(req, res) {
        const queryText = `SELECT m.First_Name as "Mentor_FirstName", m.Last_Name as "Mentor_LastName",
        m.Phone_Number as "Mentor_Phone", m.Email_Address as "Mentor_Email", m.photo as "Mentor_Photo",
    ...
    getMentee(req, res) {
        const queryText = `SELECT a.First_Name as "Awardee_FirstName", a.Last_Name as "Awardee_LastName",
        a.Phone_Number as "Awardee_Phone", a.Email_Address as "Awardee_Email",a.photo as "Awardee_Photo",
